 ...
 */
public class PortManager extends BasePortManager implements SerialPortEventListener {
	...
	public String write(byte[] command) {
		try {
			System.out.println("Sending smart object instructions...");
